...
export default function FemmeForm({ data, setData, formRefs }) {
  ...
  return (
    ...
    >
      ...
      <Form.Item name="chef_famille_mariée" label="Chef de famille">
        <Input />
      </Form.Item>
      <Form.Item name="nom_temoin_epouse" label="Nom du témoin de l’épouse">
        <Input />
      </Form.Item>
      <Form.Item name="telephone_epouse" label="Téléphone">
        <Input />
      </Form.Item>
    </Form>
  )
